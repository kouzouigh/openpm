...
class DbRealm {
    ...
    def authenticate(authToken) {
        ...
        // in the database.
        def account = new SimpleAccount(username, user.passwordHash, "exampleDbRealm")
    ...
    def isPermitted(principal, requiredPermission) {
        ...
        def results = User.executeQuery("select distinct p from exampleUser as user join user.roles as role join role.permissions as p where user.username = '$principal'")
